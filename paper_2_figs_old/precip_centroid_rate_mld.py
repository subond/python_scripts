...
if __name__ == "__main__":
    ...
    plt.savefig(plot_dir + 'precip_centroid_rate_mld.pdf', format='pdf')
    plt.close()
    ...
    # Do plots
    for i in range(5):
        p_cent_grad_scatter(runs[i], axes[i], ylim_in=1.1)
    ...
    plt.savefig(plot_dir + 'pcent_grad_scatter_mld.pdf', format='pdf')
    plt.close()
    ...
    plt.savefig(plot_dir + 'pcent_acc_scatter_mld.pdf', format='pdf')
    plt.close()
    ...
    ax1.plot([2., 5., 10., 15., 20.], max_rate, 'xk')
    ax1.set_xlabel('')
    ax1.set_ylabel('Max rate')
    
    ax2.plot([2., 5., 10., 15., 20.], max_rate_lat, 'xk')
    #ax2.set_xscale('log')
    #ax2.set_yscale('log')
