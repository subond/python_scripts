...
f1 = data_360.totp[20:56,:].plot.contourf(ax=ax2, x='xofyear', y='lat', levels = plevels, add_colorbar=False, add_labels=False, extend='max', cmap='Blues')
...
f1 = data_720.totp[60:96,:].plot.contourf(ax=ax3, x='xofyear', y='lat', levels = plevels, add_colorbar=False, add_labels=False, extend='max', cmap='Blues')
...
plt.savefig(plot_dir+'precip_mse_realtime.pdf', format='pdf')
plt.close()        
