...
def vort_eq_hm(run, lev=150, lonin=[-1.,361.], rotfac=1.0):
    ...
    f_tile = np.tile(f.values,(72,1))
    plt.contour(data.pentad, data.lat, (f_tile.T*86400.), colors='k', levels=np.arange(-12.,13.,2.))
...
vort_eq_hm('rt_2.000', rotfac=2.0)
