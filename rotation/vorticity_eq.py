...
def vort_eq(run, month, filename='plev_daily', period_fac=1.):
    ...
    ds.coords['xofyear'] = np.mod( ds.time -1., 360.*period_fac) //5 + 1.  
...
for i in range(121,481):
    ...
    vort_eq('rt_0.500', i)
    vort_eq('sn_1.000', i)
    vort_eq('sn_2.000', i, period_fac=2.)
    vort_eq('sn_0.500', i, period_fac=0.5)

save_vort_eq('rt_2.000', [121,481])
save_vort_eq('rt_0.500', [121,481])
save_vort_eq('sn_1.000', [121,481])
save_vort_eq('sn_2.000', [121,481])
save_vort_eq('sn_0.500', [121,481])
