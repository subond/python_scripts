...
for i in range(18):
    ...
    stretching_mean = get_stretching(run)
    ...
    f1 = stretching_mean.plot.contourf(x='lon', y='lat', levels = np.arange(-5.,5.1,0.5), ax=ax, extend = 'both', add_labels=False, add_colorbar=False)
...
figname = 'stretching_qflux_ll_planetary.pdf'
