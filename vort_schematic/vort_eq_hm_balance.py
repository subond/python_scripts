...
def vort_eq_hm(run, lev=150, lonin=[-1.,361.]):
    ...
    #Fourth plot
    (horiz_md_hm + stretching_hm).plot.contourf(x='xofyear', y='lat', levels=levels, ax=ax4, extend = 'both', add_labels=False, add_colorbar=False)
    ...
    if lonin == [-1.,361.]:
        ...
        figname = 'vort_budg_hm_balance' + run + '_' + str(int(lonin[0]))+ '_' + str(int(lonin[1])) + '.pdf'
