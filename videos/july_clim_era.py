# Plot up climate features (precip, winds, abs vort, tendencies) in july for ERA data
...
plt.quiver(data.lon[::3], data.lat[::1], data.ucomp[181:212,::1,::3].mean('day_of_yr'), data.vcomp[181:212,::1,::3].mean('day_of_yr'), headlength=3, headwidth=2, scale=1000., angles='xy')
land.lsm[0,:,:].plot.contour(x='longitude', y='latitude', levels=np.arange(-1.,2.,1.), add_labels=False, colors='k', linewidths=5)    
(land.z[0,:,:]/9.8).plot.contourf(x='longitude', y='latitude', levels=np.arange(2500.,100001.,97500.), add_labels=False, extend='neither', add_colorbar=False, alpha=0.5, cmap='Greys_r')    
plt.ylabel('')
plt.xlabel('')
...
plt.yticks([])
plt.tight_layout()  
plot_name = plot_dir+'wind_july.png'
...
plt.quiver(data.lon[::3], data.lat[::1], data_850_u.u_850[::1,::3,181:212].mean('day_of_yr'), data_850_v.v_850[::1,::3,181:212].mean('day_of_yr'), headlength=3, headwidth=2, scale=200., angles='xy')
land.lsm[0,:,:].plot.contour(x='longitude', y='latitude', levels=np.arange(-1.,2.,1.), add_labels=False, colors='k', linewidths=5)    
(land.z[0,:,:]/9.8).plot.contourf(x='longitude', y='latitude', levels=np.arange(2500.,100001.,97500.), add_labels=False, extend='neither', add_colorbar=False, alpha=0.5, cmap='Greys_r')    
plt.ylabel('')
plt.xlabel('')
...
plt.yticks([])
plt.tight_layout()  
plot_name = plot_dir+'wind_850_july.png'
plt.savefig(plot_name)
plt.close()



f = stretching_mean[181:212,:,:].mean('day_of_yr').plot.contourf(x='lon', y='lat', levels = np.arange(-1.5,1.75,0.25), add_labels = False, extend='both', add_colorbar=False)
land.lsm[0,:,:].plot.contour(x='longitude', y='latitude', levels=np.arange(-1.,2.,1.), add_labels=False, colors='k', linewidths=5)    
(land.z[0,:,:]/9.8).plot.contourf(x='longitude', y='latitude', levels=np.arange(2500.,100001.,97500.), add_labels=False, extend='neither', add_colorbar=False, alpha=0.5, cmap='Greys_r')    
plt.xlim(40,175)
plt.ylim(-20,60)
...
plt.yticks([])
plt.tight_layout()  
plot_name = plot_dir+'stretching_july.png'
plt.savefig(plot_name)
plt.close()    


f = horiz_adv_mean[181:212,:,:].mean('day_of_yr').plot.contourf(x='lon', y='lat', levels = np.arange(-1.5,1.75,0.25), add_labels = False, extend='both', add_colorbar=False)
land.lsm[0,:,:].plot.contour(x='longitude', y='latitude', levels=np.arange(-1.,2.,1.), add_labels=False, colors='k', linewidths=5)    
(land.z[0,:,:]/9.8).plot.contourf(x='longitude', y='latitude', levels=np.arange(2500.,100001.,97500.), add_labels=False, extend='neither', add_colorbar=False, alpha=0.5, cmap='Greys_r')    
plt.xlim(40,175)
plt.ylim(-20,60)
...
plt.yticks([])
plt.tight_layout()  
plot_name = plot_dir+'horiz_adv_july.png'
plt.savefig(plot_name)
plt.close()    


f = transient[181:212,:,:].mean('day_of_yr').plot.contourf(x='lon', y='lat', levels = np.arange(-1.5,1.75,0.25), add_labels = False, extend='both', add_colorbar=False)
land.lsm[0,:,:].plot.contour(x='longitude', y='latitude', levels=np.arange(-1.,2.,1.), add_labels=False, colors='k', linewidths=5)    
(land.z[0,:,:]/9.8).plot.contourf(x='longitude', y='latitude', levels=np.arange(2500.,100001.,97500.), add_labels=False, extend='neither', add_colorbar=False, alpha=0.5, cmap='Greys_r')    
plt.xlim(40,175)
plt.ylim(-20,60)
...
plt.yticks([])
plt.tight_layout()  
plot_name = plot_dir+'transient_vor_july.png'
plt.savefig(plot_name)
plt.close()
