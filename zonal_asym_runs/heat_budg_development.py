'''13/11/2018 Plot monthly lat-lon heat budget - how is heating balanced? NEED TO RERUN EXPERIMENTS TO GET HEAT TRANSPORT TERMS!
'''
...
def plot_heatbudg_dev(run, land_mask=None, lev=850, qscale=100., windtype='', ref_arrow=5):
