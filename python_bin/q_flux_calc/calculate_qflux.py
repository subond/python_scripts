...
def qflux_calc(dataset, model_params):
    ...
    output_dict={'manual_grid_option':False, 'is_thd':False, 'num_years':1., 'time_spacing_days':12, 'file_name':'seasonal_qflux_control_20m_test_new.nc', 'var_name':'ocean_qflux'}
...
if __name__ == "__main__":
    ...
    data.coords['month'] = data.xofyear//6 
    print data.month 
    
    #land = xr.open_dataset('/scratch/rg419/Isca/input/land_masks/era_land_42.nc')
    #data['land'] = (('lat','lon'),land.land_mask.values)
    #model_params = sagp.model_params_set('/scratch/rg419/Isca/', delta_t=720., ml_depth=20.)
