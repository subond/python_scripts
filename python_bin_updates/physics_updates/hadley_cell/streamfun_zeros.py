...
data = xr.open_dataset('/Users/ruthgeen/mnt/scratch/Data_moist/climatologies/rt_0.500.nc')
get_streamfun_zeros(data)

data = xr.open_dataset('/Users/ruthgeen/mnt/scratch/Data_moist/climatologies/sn_1.000.nc')
get_streamfun_zeros(data)

data = xr.open_dataset('/Users/ruthgeen/mnt/scratch/Data_moist/climatologies/rt_2.000.nc')
get_streamfun_zeros(data)