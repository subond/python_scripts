...
def get_edge_psi(run, lonin=[-1.,361.], sanity_check=False, lev=500., thresh=0., do_month_av=False, period_fac=1., intdown=True):
...
if __name__ == "__main__":
    #get_edge_psi('ap_2', sanity_check=True, thresh=0.)
