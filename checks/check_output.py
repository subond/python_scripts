...
#open files
#nc_file = '/scratch/rg419/workdir_moist/' + run_fol + '/np8/atmos_daily.nc'
nc_file = '/scratch/rg419/GFDL_model/GFDLmoistModel/spin_up_restart/' + run_fol + '/np8/run1/atmos_daily.nc'
#nc_file = '/scratch/rg419/Data_moist/' + run_fol + '/np8/run13/atmos_daily.nc'
...
cnv_rain = fh.variables['convection_rain']
...
# Plot Data
def plot_var_ll(var,tstep,plevel,plotno):
    if tstep < 0:
