...
data_sn1 = xr.open_dataset('/scratch/rg419/Data_moist/climatologies/sn_1.000.nc')
...
psi_u_plot(data_sn1_zs, [31,35], ax=ax7)
psi_u_plot(data_sn1_zs, [38,42], ax=ax8)
psi_u_plot(data_sn1_zs, [45,49], ax=ax9)
