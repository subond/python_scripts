...
for i in range(1,5):
    if runs[i] == 'sn_1.000':
        ...
        j=j+1
set_plot_features(ax1, title='Varying Year Lengths', legend_labels=['0.25', '0.5', '1.0', '2.0', '4.0', '8.0'], leg_title='P/P$_{E}$')
...
for i in range(1,5):
    if runs[i] == 'sn_1.000':
        ...
        j=j+1
set_plot_features(ax2, title='Varying Year Lengths (Rates scaled)', legend_labels=['0.25', '0.5', '1.0', '2.0', '4.0', '8.0'], leg_title='P/P$_{E}$')
