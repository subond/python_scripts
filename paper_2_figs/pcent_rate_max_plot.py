...
if __name__ == "__main__":
    ...
    ax1.plot([0.5, 0.75, 1., 1.25, 1.5, 1.75, 2.], max_rate_lat_5, 'xb', mew=2, ms=10)
    ax1.plot([0.5, 0.75, 1., 1.25, 1.5, 1.75, 2.], max_rate_lat_15, 'xr', mew=2, ms=10)
    #ax1.set_xscale('log')
    #ax1.set_yscale('log')
    ax1.set_ylabel('Lat. of max rate')
    
    ax2.plot([0.5, 0.75, 1., 1.25, 1.5, 1.75, 2.], max_lat, 'xk', mew=2, ms=10)
    ax2.plot([0.5, 0.75, 1., 1.25, 1.5, 1.75, 2.], max_lat_5, 'xb', mew=2, ms=10)
    ax2.plot([0.5, 0.75, 1., 1.25, 1.5, 1.75, 2.], max_lat_15, 'xr', mew=2, ms=10)
    ax2.set_xlabel('')
    #ax2.set_ylim([0,1.1])
