...
# Load in onset dates
onsets_scsm = np.load('/scratch/rg419/python_scripts/python_bin_updates/physics_updates/climatology/isca_era_onsets_scsm.npy')
onsets_bob = np.load('/scratch/rg419/python_scripts/python_bin_updates/physics_updates/climatology/era_onsets_bob_days.npy')
onsets_ism = np.load('/scratch/rg419/python_scripts/python_bin_updates/physics_updates/climatology/era_onsets_ism_days.npy')
onsets_scsm = np.array(onsets_scsm[1]) * 5. - 2.5
...
plt.grid(True,linestyle=':')
plt.savefig(plot_dir + 'scs_ism_bob_onsets_era.pdf', format='pdf')
plt.close()
...
#plt.savefig(plot_dir + 'bob_onsets_era.pdf', format='pdf')
#plt.close()
...
#plt.savefig(plot_dir + 'ism_onsets_era.pdf', format='pdf')
#plt.close()
...
#plt.savefig(plot_dir + 'scs_vs_bob_onsets_era.pdf', format='pdf')
#plt.close()
...
#plt.savefig(plot_dir + 'scs_vs_ism_onsets_era.pdf', format='pdf')
#plt.close()
...
#plt.savefig(plot_dir + 'ism_vs_bob_onsets_era.pdf', format='pdf')
#plt.close()
