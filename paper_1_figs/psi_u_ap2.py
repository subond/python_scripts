...
uv_conv_trans_before, uv_conv_stat_before, u_ztav_before = uv_partitioning(data, 30)
...
#Third plot
f2 = ax2.contourf(data.lat, data.pfull, uv_conv_trans_after, extend = 'both', levels = np.arange(-10.,10.1,2.))
...
plt.savefig(plot_dir+'psi_u_ap2.pdf', format='pdf')
plt.close()
