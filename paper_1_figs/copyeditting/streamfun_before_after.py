...
cs = ax1.contour(data.lon, data.lat, height_after.sel(pfull=150.), levels = levels_phi_high, colors='k', linewidths=2)
...
cs = ax2.contour(data.lon, data.lat, sf_after.sel(pfull=150.), colors='k', linewidths=2, levels=levels_high)
#plt.clabel(cs, fontsize=15, inline_spacing=-1, fmt= '%1.0f')
